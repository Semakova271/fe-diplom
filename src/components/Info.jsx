...
export const Info = () => {
    ...
    return (
        <div className={!info ? "info-block": "info-block active"}>
            ...
            <p className="info-text">Ничего не найдено.</p>
            <div className="info-footer">
                <button className="btn info-btn" onClick={() => setInfo(false)}>Понятно</button>
            </div>
        </div>
    )
}