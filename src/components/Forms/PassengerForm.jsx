...
import PassengersInfo from "../modules/Passengers/PassengersInfo";
import PassengersDocs from "../modules/Passengers/PassengersDocs";
import { Button, MySvgIcon } from "../../components/common/Button";
import {
  validateDataPassengers,
  validateInputForm,
} from "../../utils/formsValidator";
import { setDataPassengers } from "../../features/passengersSlice";
import icon_green_btn from "../../img/ic_green_btn.svg";
import icon_error_docs from "../../img/ic_error_docs.svg";
        ...
        {errorDocs && (
          <div className="passengers-info_status-error">
            ...
            <div className="passengers-info_error-message">
              ...
              <p className="passengers-info_error-text">
                пример:<strong className="strong-text">II-ИР-123456</strong>
              </p>
            </div>
          </div>
        )}
