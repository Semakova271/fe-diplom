...
export const FirstClass = ({item, typeTicket, onClick, type}) => {
    ...
    let boxSeatsArr = Array.from({ length: 18 }, (_, index) => index + 1);
        ...
        <>
            <div className='vagon-header'>
                <div className='vagon-header-amount'>
                    ...
                    <button className='btn vagon-header-number vagon-number-active'>02</button>
            ...
            <div className='vagon-type-block-info'>
                <div className='vagon-number-info'>
                    <span className='vagon-number'>02</span>
                    <span>Вагон</span>
                </div>
            ...
            <div className="type-vagon-first-class-block">
                <div className="type-vagon-first-class-info">
                    <span>19 человек выбирают места в этом поезде</span>
                </div>
                <div className="type-vagon-first-class">
                    <div className="type-vagon-first-class-luxe">
                        {
                            arrSeats.map(i => {
                                return (
                                <div key={i[0]} className="type-vagon-first-class-seats">
                                    <button
                                        data-id={i[0]}
                                        data-id_vagon={item.coach._id}
                                        data-price={item.coach.bottom_price}
                                        className={"btn type-vagon-first-class-seat" + getClassName(i[0], item)} 
                                    ...
                                    <button 
                                        ...
                                        data-id_vagon={item.coach._id}
                                        data-price={item.coach.bottom_price}
                                        className={"btn type-vagon-first-class-seat" + getClassName(i[1], item)} 
