...
import { Button, Title } from "../../BasicComponents/BasicComponents";
import { PassengersForm } from "../../Forms/Forms";

// Компонент блока пассажира
export const BlockItem = React.forwardRef(
...
// Компонент добавления пассажира
export const AddPassengerBlock = ({ state, setState }) => {
